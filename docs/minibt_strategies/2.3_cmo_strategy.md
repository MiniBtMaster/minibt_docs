...
if __name__ == "__main__":
    Bt().run()
```
![](https://minibt-img.oss-cn-shenzhen.aliyuncs.com/plot/2_3_1.png)
![](https://minibt-img.oss-cn-shenzhen.aliyuncs.com/plot/2_3_2.png)
![](https://minibt-img.oss-cn-shenzhen.aliyuncs.com/plot/2_3_3.png)
## 参数说明
