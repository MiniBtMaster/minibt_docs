...
if __name__ == "__main__":
    Bt().run()
```
![](https://minibt-img.oss-cn-shenzhen.aliyuncs.com/plot/2_7_1.png)
![](https://minibt-img.oss-cn-shenzhen.aliyuncs.com/plot/2_7_2.png)
![](https://minibt-img.oss-cn-shenzhen.aliyuncs.com/plot/2_7_3.png)
## 参数说明
