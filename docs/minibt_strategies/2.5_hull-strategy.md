...
if __name__ == "__main__":
    Bt().run()
```
![](https://minibt-img.oss-cn-shenzhen.aliyuncs.com/plot/2_5_1.png)
![](https://minibt-img.oss-cn-shenzhen.aliyuncs.com/plot/2_5_2.png)
![](https://minibt-img.oss-cn-shenzhen.aliyuncs.com/plot/2_5_3.png)
## 参数说明
