...
最大回撤：0.1263%
```
![](https://minibt-img.oss-cn-shenzhen.aliyuncs.com/plot/4_5_1.png)
![](https://minibt-img.oss-cn-shenzhen.aliyuncs.com/plot/4_5_2.png)
### 验证（亏损）：
```
最终收益：-215.00（-0.02%）
夏普比率：-0.0379
...
最大回撤：0.1204%
```
![](https://minibt-img.oss-cn-shenzhen.aliyuncs.com/plot/4_5_3.png)
![](https://minibt-img.oss-cn-shenzhen.aliyuncs.com/plot/4_5_4.png)
## 问题分析与改进建议
