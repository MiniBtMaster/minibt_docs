...
## 📊 训练过程总结
![](https://minibt-img.oss-cn-shenzhen.aliyuncs.com/plot/4_1_1.png)
![](https://minibt-img.oss-cn-shenzhen.aliyuncs.com/plot/4_1_2.png)
### 训练表现指标分析
...
![](https://minibt-img.oss-cn-shenzhen.aliyuncs.com/plot/4_1_3.png)
![](https://minibt-img.oss-cn-shenzhen.aliyuncs.com/plot/4_1_4.png)
**收益表现：**
